...
export default async function LatestInvoices() {
  ...
  return (
    <div className="flex w-full flex-col md:col-span-4">
      ...
      <div className="flex grow flex-col justify-between rounded-2xl border border-neutral-200 bg-white p-4 shadow-[0_12px_24px_rgba(15,23,42,0.06)] dark:border-neutral-800 dark:bg-neutral-950 dark:shadow-[0_18px_35px_rgba(0,0,0,0.45)]">
        {isEmpty ? (
          ...
          <div className="rounded-xl border border-neutral-200 bg-slate-50 px-4 py-3 dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div className="hidden md:block">
              <div className="grid grid-cols-[120px_minmax(0,1fr)_120px_110px] gap-4 border-b border-neutral-200 px-2 py-2 text-xs uppercase tracking-[0.12em] text-slate-500 dark:border-neutral-800">
                <span>Invoice</span>
                <span>Customer</span>
                ...
                return (
                  <div
                    ...
                    className={clsx(
                      ...
                      { 'border-t border-neutral-200 dark:border-neutral-800': i !== 0 },
                    )}
                  >

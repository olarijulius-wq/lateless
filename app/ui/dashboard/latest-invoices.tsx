...
export default async function LatestInvoices() {
  ...
  return (
    <div className="flex w-full flex-col md:col-span-4">
      ...
      <div className="flex grow flex-col justify-between rounded-2xl border border-neutral-200 bg-white p-4 shadow-[0_12px_24px_rgba(15,23,42,0.06)] dark:border-zinc-800 dark:bg-black dark:shadow-[0_18px_35px_rgba(0,0,0,0.45)]">
        {isEmpty ? (
